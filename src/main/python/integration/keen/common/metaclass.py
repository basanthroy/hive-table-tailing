...
metaclass_info = {"tracker_event"           : {klass : TrackerEventTSTransformer(),
                  ...
                  "web_analytics":            {klass: WebAnalyticsTransformer(),
                                               hive_db: "broy",
                                               hive_table: "web_analytics2",
                                               hive_line_parser: (lambda line: json.loads(line)),
                                               keen_collection: "web_analytics",
                                               keen_collection_name_function: (lambda coll, data_sink_logger_tuple:
                                                                               "zz_basanth_test_" + coll + "_" + str(data_sink_logger_tuple[4])
                                                                             # "zz_basanth_test_" + str(data_sink_logger_tuple[4])
                                                                             ),
                                               entity_base_dir_template: "hdfs://server:8020/user/hive/warehouse/broy.db/web_analytics2/dt={}/hr={}/",
                                               entity_filepath_template: "hdfs://server:8020/user/hive/warehouse/broy.db/web_analytics2/dt={}/hr={}/{}",
                                               file_list_retriever: FileListRetrieverTrackerEventJson
                                              },
